...
public class AndroidPHPConnectionDemo extends Activity {
    ...
    void login(){
        try{
            ...
            httppost= new HttpPost("http://www.shilaoshiyongyuan.dx.am/check.php"); // make sure the url is correct.
            //add your data
            ...
            if(response.equalsIgnoreCase("User Found")){
                ...
                Intent intent = new Intent(AndroidPHPConnectionDemo.this, UserPage.class);
